...
ggplot(quantity_drugs_seized_by_kg,aes(x = year_new, y = amount_new, fill = drug)) + 
  ...
  labs(x = "Drug", y = "Quantity (in Kilograms)", title = "Quantity of Drugs Seized (in Kilograms)", fill = "Drug Type")

ggplot(quantity_drugs_seized_by_g,aes(x = year_new, y = amount_new, fill = drug)) + 
  geom_bar(position = "dodge", stat = "identity") +
  labs(x = "Drug", y = "Quantity (in Grams)", title = "Quantity of Drugs Seized (in Grams)", fill = "Drug Type")

ggplot(quantity_drugs_seized_by_tablets,aes(x = year_new, y = amount_new, fill = drug)) + 
  geom_bar(position = "dodge", stat = "identity") +
  labs(x = "Drug", y = "Quantity (in Tablets)", title = "Quantity of Drugs Seized (in Tablets)", fill = "Drug Type")
```
